...
## 런칭 요청 시 재개할 작업 (2026-09-14 사용자 지정)

- 지금 진행: 2 코드 통합, 3 요청 오류 수정 운영 반영, 4 운영 Safety 관측, 7 백업·롤백·비용 대조.
- 사용자가 ONARIA를 "런칭하자", "런칭한다", "출시하자" 등으로 요청하면 먼저 `docs/LAUNCH_CHECKLIST.md`를 읽고 1·5·6·8번이 대기 중임을 알려준 뒤 해당 작업을 재개한다.
- 대기 작업: 1 피드백 API 통합·배포, 5 종교 자료 사용권·승인·검토, 6 실기기 음성·네트워크·알림 검증, 8 실제 로그인·결제·유료 권한 검증.
- 이는 대화의 런칭 요청을 기준으로 한 작업 일정이며, 날짜 기반 알람이나 무인 실행이 아니다. 기존 운영·서명·개인정보 승인 경계는 유지한다.
