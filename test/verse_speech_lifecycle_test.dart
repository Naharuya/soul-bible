    ...
    testWidgets('bundled Korean speech lifecycle: $action', (tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          ...
          home: ConversationPage(
              emotion: EmotionType.anxiety, intensity: 5, apiClient: client)));
      ...
      for (var turn = 0; turn < 3; turn++) {
        ...
        await tester.pumpAndSettle();
        final offline = find.text('AI 없이 다음 단계');
      ...
      final play = tester.widget<OutlinedButton>(
          find.widgetWithText(OutlinedButton, '오늘의 말씀 음성으로 듣기'));
      play.onPressed!();
      await tester.pumpAndSettle();
      expect(spoken, 1);
      if (action == 'leave') {
        ...
        tester
            .widget<OutlinedButton>(
                find.widgetWithText(OutlinedButton, '말씀 낭독 멈추기'))
            .onPressed!();
