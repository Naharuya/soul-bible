...
| 미니게임 | [cross_light](../../lib/engagement/mini_games/cross_light) | 메인 메뉴·말씀 기록 화면에서 진입. 여섯 별빛을 직접 터치해 십자가로 모으기·일시정지·재시작·완료 말씀 연결. [검증 기록](../archive/CROSS_LIGHT_GAME_REPORT.md) |
...
수정 및 산출물 이력: [APP_RUNTIME_REPAIR_REPORT.md](../archive/APP_RUNTIME_REPAIR_REPORT.md). 과거 빌드 기록: [BUILD_REPAIR_REPORT.md](../archive/BUILD_REPAIR_REPORT.md). 보안 검토 기록: [SECURITY_PRIVACY_REVIEW.md](../archive/SECURITY_PRIVACY_REVIEW.md).
